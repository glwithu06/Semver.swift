...
class SemverTests: XCTestCase {
    ...
    func testEqualBasicVersion() {
        ...
        // Big number
        XCTAssertEqual("69938113471411635120691317071569414.452.368".version!,
                       Semver(major: "69938113471411635120691317071569414", minor: "452", patch: "368"))
        XCTAssertNotEqual("69938113471411635120691317071569414.452.36".version!,
                          "69938113471411635120691317071569414.452.368".version!)
        // prefixed
